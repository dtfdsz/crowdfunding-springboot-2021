package com.xys.scw.user.service.impl;
...
import com.xys.scw.user.bean.TMemberAddressExample;
import com.xys.scw.user.bean.TMemberExample;
import com.xys.scw.user.exp.UserException;
import com.xys.scw.user.mapper.TMemberAddressMapper;
import com.xys.scw.user.mapper.TMemberMapper;
...
public class TMemberServiceImpl implements TMemberService {
	...
	public UserRespVo getUserByLogin(String loginacct,String password) {
		...
		if(!encoder.matches(password,member.getUserpswd())) {
			throw new UserException(UserExceptionEnum.USER_PSWD_ERROR);
		}
